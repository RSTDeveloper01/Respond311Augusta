    ...
    if(open311.accounts == nil || (open311.accounts!= nil && open311.accounts.count == 0)){
        ...
        if(currentServer == nil)
        {
            NSDictionary* server= [[NSDictionary alloc]initWithObjectsAndKeys:
                                   ...
                                   @"Respond311Augusta",kOpen311_Name,
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if(indexPath.row ==2){
            urlToWebView = @"http://respond311augustaweb.respondcrm.com/Pages/KBSearch.aspx";
        ...
        if(indexPath.row ==3){
            urlToWebView = @"http://respond311augustaweb.respondcrm.com/Pages/Calendar.aspx";
//WebViewController *webController = [[WebViewController alloc] initWithNib:@"WebViewController" bundle:nil];
            //webController.viewURL = @"www.google.com"; // Set the exposed property
        ...
        if(indexPath.row ==4){
            urlToWebView = @"http://toledo.oh.gov/news/";
            //WebViewController *webController = [[WebViewController alloc] initWithNib:@"WebViewController" bundle:nil];
            //webController.viewURL = @"www.google.com"; // Set the exposed property
        ...
        if(indexPath.row ==5){
            urlToWebView = @"http://respond311augustaweb.respondcrm.com/pages/casemap.aspx";
            //WebViewController *webController = [[WebViewController alloc] initWithNib:@"WebViewController" bundle:nil];
            //webController.viewURL = @"www.google.com"; // Set the exposed property
        ...
        if(indexPath.row ==6){
            urlToWebView = @"https://www.facebook.com/augustaga.gov/";
            //WebViewController *webController = [[WebViewController alloc] initWithNib:@"WebViewController" bundle:nil];
            //webController.viewURL = @"www.google.com"; // Set the exposed property
        ...
        if(indexPath.row ==7){
            urlToWebView = @"https://twitter.com/CityofAugusta";
            //WebViewController *webController = [[WebViewController alloc] initWithNib:@"WebViewController" bundle:nil];
            //webController.viewURL = @"www.google.com"; // Set the exposed property
